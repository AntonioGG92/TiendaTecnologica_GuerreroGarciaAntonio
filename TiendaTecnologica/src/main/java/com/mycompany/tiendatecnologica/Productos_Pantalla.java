 ...
 private void cargarCategorias() {
    ...
    try {
        ...
        if (rs.next()) {
            ...
            // Cargar la imagen desde la URL almacenada en imagen_blob
            String rutaImagen = rs.getString("imagen_blob");
                ...
                try {
                    ...
                    if (archivoImagen.exists()) {
                        ...
                        if (imagen != null) {
                            ...
                            System.out.println("Imagen cargada correctamente para el producto: " + productoSeleccionado);
                        } else {
                            System.out.println("No se pudo leer la imagen para el producto: " + productoSeleccionado);
                            jLabel1.setIcon(null);
                        }
                    } else {
                        System.out.println("No se encontró el archivo de imagen para el producto: " + productoSeleccionado + " en la ruta: " + archivoImagen.getAbsolutePath());
                        jLabel1.setIcon(null);
                    }
                } catch (Exception e) {
