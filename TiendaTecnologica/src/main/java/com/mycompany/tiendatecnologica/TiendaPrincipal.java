...
public class TiendaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\marta\\Desktop\\technology_store_background_rescaled.png")); // NOI18N
        ...
        label1.setFont(new java.awt.Font("Gadugi", 3, 24)); // NOI18N
        label1.setForeground(new java.awt.Color(0, 255, 255));
        label1.setText("Mi Tienda Tecnológica");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        Comprar_Pantalla comprarPantalla = new Comprar_Pantalla();
        comprarPantalla.setVisible(true);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        HistorialDeCompra_Pantalla historialDeCompraPantalla = new HistorialDeCompra_Pantalla();
        historialDeCompraPantalla.setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Productos_Pantalla productosPantalla = new Productos_Pantalla();
        productosPantalla.setVisible(true);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Usuarios_Pantalla usuariosPantalla = new Usuarios_Pantalla();
        usuariosPantalla.setVisible(true);
